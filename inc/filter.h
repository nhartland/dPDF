...
void InitData(libconfig::Config const& settings, std::vector<NNPDF::Experiment>&);
void InitData(libconfig::Config const& settings, std::vector<NNPDF::Experiment>&, std::vector<NNPDF::Experiment>&);
